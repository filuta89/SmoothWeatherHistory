...
class WeatherController extends AbstractController
{
    ...
    {
        dump('fetchWeatherAction() called', true);
//        $logger->info('fetchWeatherAction() called');
        ...
        try {
            ...
            try {
                ...
                dump('----------------------------array of old responseIds------------------------>', true);
                dump($responseId, true);
//                $logger->info('----------------------------array of old responseIds------------------------>' . print_r($responseId, true));
            ...
            if ($form->isSubmitted() && $form->isValid()) {
                try {
                    ...
                    dump('----------------------------$newResponseId------------------------>', true);
                    dump($newResponseId[0], true);
//                    $logger->info('----------------------------$newResponseId------------------------>' . print_r($newResponseId[0], true));

                    dump('----------------------------$newWeatherData------------------------>', true);
                    dump($newWeatherData, true);
